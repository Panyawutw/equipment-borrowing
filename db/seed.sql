...
INSERT INTO
    students (student_id, full_name, major, email)
VALUES
    (
        '66010001',
        'กานต์ ก้าวไกล',
        'เทคโนโลยีสารสนเทศ',
        '66010001@example.ac.th'
    ),
    (
        '66010002',
        'ขวัญใจ เรียนดี',
        'วิทยาการคอมพิวเตอร์',
        '66010002@example.ac.th'
    ),
    (
        '66010003',
        'ชลธี สร้างสรรค์',
        'เทคโนโลยีสารสนเทศ',
        '66010003@example.ac.th'
    ),
    (
        '66010004',
        'ดาริน ทดลอง',
        'วิทยาการคอมพิวเตอร์',
        '66010004@example.ac.th'
    ),
    (
        '66010005',
        'ธนภัทร พัฒนา',
        'เทคโนโลยีสารสนเทศ',
        '66010005@example.ac.th'
    );
